...
if [ "${1}" == "-?" -o "${1}" == "" ] ; then
echo "==--==--==--==--==--==--==--==--==--==--==--==--==--==--=="
echo "Genera la estructura pretty para un servidor en arquitectura Brqx [$VER]"
echo "=========================================================="
echo "Format  : wspg [file_waf] [file_loc]                 		"
echo "----------------------------------------------------------"
