...
echo "=========================================================="
echo "Format  : mymvlan  SOURCE TARGET                          "
echo "----------------------------------------------------------"
echo "Example : mymvlan rct_p50main_n_aa rct_p50co_n_aa	    	    "
echo "==--==--==--==--==--==--==--==--==--==--==--==--==--==--=="

else
#mymvlan rct_p50main rrct_p50co
#mymv rct_p50main_n_aa rct_p50co_n_aa
...
mymv "${DB_NAME_SRC}${LAN_NAME}" "${DB_NAME_TAR}${LAN_NAME}"
