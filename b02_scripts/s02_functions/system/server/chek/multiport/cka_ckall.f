...
#+ Ejemplo : 
#-------------------------------------------------------------------
#E cka brqx.es 	-- Comprueba puertos contra el dominio 
#-------------------------------------------------------------------
...
cka_NFO="Comprobacion multi puerto en dominio [$VER]"
cka_FMT="cka [DOMAIN]"
cka_EXA="cka pbrqx.com"
...
#--------------------------------------------------------------------------------
header_full "${cka_NFO}" "${cka_FMT}" "${cka_EXA}"
#--------------------------------------------------------------------------------
else
